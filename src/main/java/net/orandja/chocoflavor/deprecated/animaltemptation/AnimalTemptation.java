...
//    }
//
//    Map<Class<? extends AnimalEntity>, GlobalUtils.PairSupplier<Integer, TemptItemGoal, AnimalEntity>> TEMPTATIONS = Maps.newHashMap();
//
//    static void getTemptation(AnimalEntity animal, Consumer<GlobalUtils.PairSupplier<Integer, TemptItemGoal, AnimalEntity>> consumer) {
...
//            getTemptation(animal, pair -> addGoal(this.vw$_getGoalSelector(), pair.get(animal)));
//        }
//    }
//}
