...
//
//    Map<BlockEntityType<?>, BlockEntityTicker<?>> tickers = new HashMap<>();
//    static <T extends BlockEntity> BlockEntityTicker<T> getTicker(BlockEntityType<T> type) {
//        return (BlockEntityTicker<T>) tickers.get(type);
//    }
//
