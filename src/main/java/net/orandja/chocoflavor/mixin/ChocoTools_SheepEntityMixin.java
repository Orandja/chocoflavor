...
public abstract class ChocoTools_SheepEntityMixin extends AnimalEntity {

    protected ChocoTools_SheepEntityMixin(EntityType<? extends AnimalEntity> entityType, World world) {
