...
public abstract class ChocoMiscs_KelpPlantBlockMixin extends AbstractPlantBlock implements FluidFillable {
    protected ChocoMiscs_KelpPlantBlockMixin(Settings settings, Direction direction, VoxelShape voxelShape, boolean bl) {
    ...
    boolean isKelp(World world, BlockPos pos) {
