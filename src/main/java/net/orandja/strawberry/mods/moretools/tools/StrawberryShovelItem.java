...
public class StrawberryShovelItem extends ShovelItem implements StrawberryItem {

    private final int customDataModel;
    private final ShovelItem replacementItem;

    public StrawberryShovelItem(CustomToolMaterial material, Item replacementItem, int customDataModel) {
