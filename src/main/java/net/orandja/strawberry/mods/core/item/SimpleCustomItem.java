...
public class SimpleCustomItem extends Item implements StrawberryItem {
    ...
    public SimpleCustomItem(String name, Item replacementItem, int customDataModel, Settings settings) {
        this(name, null, replacementItem, customDataModel, settings);
    }
    ...
    public void register() {
        register(this.replacementItem, this.customDataModel, Registries.ITEM.getId(this).getPath(), this.texture == null ? Registries.ITEM.getId(this).getPath() : this.texture);
    }
}
