...
public abstract class StrawberryEnchantedBlockUI_HopperBlockEntityMixin
        extends LockableContainerBlockEntity
        implements StrawberryEnchantedBlockUI.EnchantedSideUI {

    protected StrawberryEnchantedBlockUI_HopperBlockEntityMixin(BlockEntityType<?> blockEntityType, BlockPos blockPos, BlockState blockState) {
